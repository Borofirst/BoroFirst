...
const ContactUs = () => {
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute left-1/2 top-0 h-px w-full max-w-7xl -translate-x-1/2 bg-gradient-to-r from-transparent via-[#10B981]/30 to-transparent" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-[22px] bg-white lg:rounded-[26px]">
            ...
            {/* Top accent */}
            <div className="h-1 w-full bg-gradient-to-r from-[#186A07] via-[#10B981] to-[#0B2578]" />
