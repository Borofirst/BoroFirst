  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-5 shadow-[0_10px_35px_rgba(15,23,42,0.05)] transition-all duration-300 hover:-translate-y-1 hover:border-emerald-200 hover:shadow-[0_18px_45px_rgba(24,106,7,0.10)]">
      ...
      <div className="relative">
        <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-[#0B2578] to-[#186A07] text-white shadow-lg shadow-blue-900/10">
    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mb-16 max-w-3xl text-center lg:mb-20">
          ...
          >
            Financial Solutions
            <span className="block bg-gradient-to-r from-[#0B2578] via-[#186A07] to-[#0B2578] bg-clip-text text-transparent">
        ...
        <div className="mt-20 overflow-hidden rounded-[2rem] bg-gradient-to-r from-[#071a59] via-[#0B2578] to-[#123f86] shadow-[0_25px_70px_rgba(11,37,120,0.16)] lg:mt-24">
            ...
            <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              <div className="max-w-xl">
                ...
                <p className="mt-3 text-sm leading-6 text-blue-100/75 sm:text-base">
                  Explore financial solutions designed to support your personal
                  goals, family aspirations and business ambitions.
                </p>
              </div>
        ...
        <div className="mt-20 lg:mt-24 lg:items-center">
          <div>
            ...
            <p className=" mt-6 max-w-xl text-base leading-7 text-slate-500 sm:text-lg sm:leading-8">
              Borofirst brings together a broad network of financial partners
              to help customers explore solutions with greater choice and
              confidence.
            </p>
          </div>
        ...
        {/* Bottom Statement */}
        <div className=" border-t border-slate-100 pt-12 text-center lg:mt-24 lg:pt-16">
          <div className="mx-auto max-w-3xl">
            <div className="mx-auto mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-50 to-blue-50 text-[#0B2578]">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-500 sm:text-base">
              From exploring your options to taking the next step, Borofirst is
              committed to creating a financial experience that puts people
              first.
            </p>

            <a
              href="/contact"
              className="mt-7 inline-flex items-center gap-2 font-bold text-[#0B2578] transition-colors hover:text-[#186A07]"
            >
              Start your journey
              <ArrowRight
                size={17}
