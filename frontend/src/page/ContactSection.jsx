...
/>
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              Whether you're looking for a personal loan, home loan,
              business financing, insurance, or investment guidance,
              our financial experts are here to help you choose the
              right solution with complete transparency.
    ...
    <div className="grid gap-6 md:grid-cols-2">
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-2xl border border-gray-300 px-5 py-4 outline-none transition-all duration-300 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100"
        />
    ...
    <div className="grid gap-6 md:grid-cols-2">
      ...
      <div>
        ...
        <select
          ...
          onChange={handleChange}
          className="w-full rounded-2xl border border-gray-300 bg-white px-5 py-4 outline-none transition-all duration-300 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100"
        >
  ...
  <p className="mt-2 text-sm text-red-500">
    ...
    <div>
      ...
      <textarea
        ...
        className="w-full resize-none rounded-2xl border border-gray-300 px-5 py-4 outline-none transition-all duration-300 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100"
      />
