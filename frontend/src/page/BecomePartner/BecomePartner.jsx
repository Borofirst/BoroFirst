...
const PartnerCard = ({ name, initials }) => (
  <div className="group relative flex min-h-[142px] flex-col justify-between overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-5 shadow-[0_8px_30px_rgba(15,23,42,0.04)] transition-all duration-300 hover:-translate-y-1 hover:border-[#186A07]/25 hover:shadow-[0_18px_40px_rgba(15,23,42,0.09)]">
    ...
    <div className="relative flex items-start justify-between">
      <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-slate-100 bg-linear-to-br from-slate-50 to-white text-[11px] font-extrabold tracking-tight text-slate-700 shadow-sm transition-all duration-300 group-hover:border-emerald-100 group-hover:bg-[#EAF5E8] group-hover:text-[#186A07]">
        {initials}
      </div>
...
const BecomePartner = () => {
  ...
  */
  ...
  const validateForm = () => {
    const { fullName, company, email, phone, partnershipType, message } =
      formData;
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      */
      ...
      console.error("Partner form submission error:", submitError);

      setError(
        submitError.message || "Something went wrong. Please try again later.",
      );
    } finally {
  ...
  return (
    <>
      ...
      <main className="overflow-hidden bg-white text-slate-900">
        {/* Hero */}
        <section className="relative isolate overflow-hidden bg-linear-to-b from-[#F7FBF6] via-white to-white">
          ...
          <div className="absolute inset-0 -z-10 opacity-[0.22] [background-image:linear-linear(rgba(24,106,7,0.12)_1px,transparent_1px),linear-linear(90deg,rgba(24,106,7,0.12)_1px,transparent_1px)] [background-size:48px_48px] [mask-image:linear-linear(to_bottom,black,transparent)]" />
          ...
          <div className="mx-auto max-w-7xl px-6 pb-16 pt-28 sm:px-8 lg:px-10 lg:pb-20 lg:pt-36">
            <div className="grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
              <div className="max-w-3xl">
                <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-emerald-100 bg-white/80 px-3.5 py-2 shadow-sm backdrop-blur">
                  <Sparkles size={14} className="text-[#186A07]" />
                ...
                <p className="mt-6 max-w-2xl text-base leading-7 text-slate-500 sm:text-lg sm:leading-8">
                  ...
                  journeys. We welcome institutions that share our commitment to
                  responsible, customer-focused financial solutions.
                </p>

                <div className="mt-8 flex flex-wrap gap-3">
                  <a
                    href="#become-partner"
                    className="group inline-flex items-center gap-2 rounded-xl bg-linear-to-r from-[#186A07] to-[#0B2578] px-5 py-3 text-sm font-bold text-white shadow-lg shadow-emerald-900/10 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl"
                  >
              ...
              <div className="relative mx-auto w-full max-w-md">
                <div className="absolute inset-8 rounded-[3rem] bg-linear-to-br from-emerald-100/60 to-blue-100/60 blur-3xl" />
            ...
            <div className="mt-12 grid grid-cols-2 gap-3 lg:grid-cols-4">
              {stats.map((stat) => (
                <PartnerStat key={stat.label} {...stat} />
              ))}
            </div>
          </div>
        </section>
        ...
        <section className="px-6 py-16 sm:px-8 lg:px-10">
          <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2rem] bg-linear-to-r from-[#186A07] to-[#0B2578] px-7 py-10 shadow-[0_25px_70px_rgba(11,37,120,0.18)] sm:px-10 lg:px-14 lg:py-12">
            ...
            <div className="absolute inset-0 opacity-[0.08] [background-image:linear-linear(rgba(255,255,255,1)_1px,transparent_1px),linear-linear(90deg,rgba(255,255,255,1)_1px,transparent_1px)] [background-size:36px_36px]" />
        ...
        <section
          id="become-partner"
          className="relative overflow-hidden bg-linear-to-b from-white to-[#F7FBF6] py-20 sm:py-24"
        >
          ...
          <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
            <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
              ...
              {/* Form */}
              <div className="relative">
                <div className="absolute -inset-3 rounded-[2rem] bg-linear-to-br from-emerald-100/40 to-blue-100/40 blur-2xl" />
