  ...
  return (
    <section className="relative overflow-hidden bg-slate-50 py-20 lg:py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
            ...
            {loanNeeds.map((item) => {
              ...
              return (
                <button
                  ...
                  ${
                    active
                      ? "border-transparent bg-linear-to-r from-[#186A07] to-[#0B2578] text-white shadow-xl"
        ...
        <div className="mt-20 rounded-[32px] bg-linear-to-r from-[#186A07] to-[#0B2578] p-10 text-white shadow-2xl lg:p-14">
          <div className="flex flex-col items-center justify-between gap-10 lg:flex-row">
            ...
            <div className="max-w-2xl">
              ...
              <p className="mt-5 text-lg leading-8 text-emerald-50">
                ...
                funding higher education, or managing unexpected expenses, our
                financial advisors will help you choose the right loan.
              </p>
            </div>
